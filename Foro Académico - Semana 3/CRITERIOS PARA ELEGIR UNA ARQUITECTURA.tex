...
\begin{document}
	...
	El tipo de aplicación no determina por sí solo la arquitectura que debe
	utilizarse. Por ejemplo, una aplicación web pequeña puede funcionar
	correctamente con una arquitectura monolítica, mientras que una plataforma web
	con miles de usuarios podría requerir microservicios, procesamiento de eventos
	y recursos escalables. Por ello, la decisión debe basarse en los requisitos y
	las características reales del proyecto.
